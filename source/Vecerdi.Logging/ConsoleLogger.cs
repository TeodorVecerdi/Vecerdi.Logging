...
internal class ConsoleLogger : ILogger {
    ...
    public void Message(ReadOnlySpan<char> message, ReadOnlySpan<char> category = default, object? context = null, LogLevel logLevel = LogLevel.Information) {
    ...
    public void Exception(Exception? exception, ReadOnlySpan<char> category = default, object? context = null, LogLevel logLevel = LogLevel.Error) {
        string m = context is not null
